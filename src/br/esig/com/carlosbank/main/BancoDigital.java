package br.esig.com.carlosbank.main;
...
import br.esig.com.carlosbank.dominio.Conta;
import br.esig.com.carlosbank.dominio.Genero;
import br.esig.com.carlosbank.negocio.TransacaoHelper;
import br.esig.com.carlosbank.negocio.ValidacaoHelper;

/** Esta entidade gerencia uma conta digital.
 * 
...
public class BancoDigital {
	...
	public static void main(String[] args) {
		...
		System.out.println("*------------------------------------------------------------*");
		System.out.println("|Bem vindo ao CarlosBank!                                        |");
		...
		try {
			do {
				...
				case "1":
					...
					System.out.print("Informe o gênero da pessoa (Masculino ou Feminino): ");
